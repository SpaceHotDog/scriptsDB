...
mydb = mysql.connector.connect(
    host="192.168.33.80",
    user="celulares_admin",
    passwd="celuser.3135",
    database="celulares_2019"
)
...
vueltas1 = mycursor.fetchone()[0] / 10000
offset1 = 0
...
for a in range(int(vueltas1 + 1)):
    ...
    mycursor2.execute("SELECT * FROM datos LIMIT 10000 OFFSET " + str(offset1))
    offset1 += 10000
...
vueltas2 = mycursor.fetchone()[0] / 10000
offset2 = 0
...
for a in range(int(vueltas2 + 1)):
    ...
    mycursor2.execute("SELECT * FROM datos2 LIMIT 10000 OFFSET " + str(offset2))
    offset2 += 10000
...
vueltas3 = mycursor.fetchone()[0] / 10000
offset3 = 0
...
for a in range(int(vueltas3 + 1)):
    ...
    mycursor2.execute("SELECT * FROM datos3 LIMIT 10000 OFFSET " + str(offset3))
    offset3 += 10000
...
vueltas4 = mycursor.fetchone()[0] / 10000
offset4 = 0
...
for a in range(int(vueltas4 + 1)):
    ...
    mycursor2.execute("SELECT * FROM datos4 LIMIT 10000 OFFSET " + str(offset4))
    offset4 += 10000
